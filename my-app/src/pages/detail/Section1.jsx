      ...
      <div className="max-w-7xl mx-auto px-6 md:px-4 py-6 md:py-8">
        ...
        <div className="grid md:grid-cols-2 gap-10 md:gap-20 items-start">
          ...
          <div className="space-y-4">
            <h1 className="text-2xl md:text-3xl font-semibold text-[#252B42]">{name}</h1>
  ...
  return (
    <div className="flex items-center gap-1">
      {Array.from({ length: 5 }).map((_, i) => {
        ...
        return (
          <svg key={i} width="20" height="20" viewBox="0 0 24 24" fill={active ? "#FBBF24" : "none"} stroke="#FBBF24">
